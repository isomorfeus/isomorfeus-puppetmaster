...
module DriverSpec
  describe 'chromium' do
    ...
    it_behaves_like 'document awaits a promise'
    ...
    it 'url_blacklists can be configured in the driver' do
      ...
      session = open_new_session(Isomorfeus::Puppetmaster.served_app, :chromium_blacklist)
    ...
    it 'HTTPS errors can be ignored by default' do
      ...
      session = open_new_session(Isomorfeus::Puppetmaster.served_app, :chromium_allow_ssl)
      doc = session.default_document
    ...
    it 'viewport allows for custom maximization size' do
      ...
      session = open_new_session(Isomorfeus::Puppetmaster.served_app, :chromium_with_custom_max_size)
      doc = session.default_document
      doc.visit('/')
