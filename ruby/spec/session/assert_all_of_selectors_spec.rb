...
Isomorfeus::Puppetmaster::SpecHelper.spec '#assert_all_of_selectors' do
  before do
...
Isomorfeus::Puppetmaster::SpecHelper.spec '#assert_none_of_selectors' do
  before do
    @session.visit('/with_html')
  end
...
Isomorfeus::Puppetmaster::SpecHelper.spec '#assert_any_of_selectors' do
  before do
    @session.visit('/with_html')
  end
