...
Isomorfeus::Puppetmaster::SpecHelper.spec '#has_field' do
...
Isomorfeus::Puppetmaster::SpecHelper.spec '#has_no_field' do
  before { @session.visit('/form') }
...
Isomorfeus::Puppetmaster::SpecHelper.spec '#has_checked_field?' do
  before { @session.visit('/form') }
...
Isomorfeus::Puppetmaster::SpecHelper.spec '#has_no_checked_field?' do
  before { @session.visit('/form') }
...
Isomorfeus::Puppetmaster::SpecHelper.spec '#has_unchecked_field?' do
  before { @session.visit('/form') }
...
Isomorfeus::Puppetmaster::SpecHelper.spec '#has_no_unchecked_field?' do
  before { @session.visit('/form') }
