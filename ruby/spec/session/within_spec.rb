...
Isomorfeus::Puppetmaster::SpecHelper.spec '#within' do
  before do
...
Isomorfeus::Puppetmaster::SpecHelper.spec '#within_fieldset' do
  before do
...
Isomorfeus::Puppetmaster::SpecHelper.spec '#within_table' do
  before do
